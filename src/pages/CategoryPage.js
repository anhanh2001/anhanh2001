    ...
    async render(){
        ...
        <div class="product-block product-resize site-animation">
            <div class="product-img">
                ...
                <a href="/products/giay-cuoi-co-dau-dinh-hoa-ket-cuom-cao-9cm" title="${product.name}" class="image-resize fade-box">
                    <picture>
                ...
                <div class="productQuickView">
                    <a class="btnProductQuickview" href="javascript:void(0)" data-handle="giay-cuoi-co-dau-dinh-hoa-ket-cuom-cao-9cm" title="Xem nhanh"></a>
                </div>
            ...
            <div class="product-detail clearfix">
                <div class="box-pro-detail">
                    <h3 class="pro-name">
                        <a href="/products/giay-cuoi-co-dau-dinh-hoa-ket-cuom-cao-9cm" title="Giày cưới cô dâu đính hoa kết cườm cao 9cm">
                            Giày cưới cô dâu đính hoa kết cườm cao 9cm
                        </a>
                    </h3>
